 <main role="main" class="col-md-9 ml-sm-auto col-lg-9 pt-3 px-4">
          ...
          <form>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="exampleFormControlInput2" placeholder="Author Name">
            </div>
            <div class="form-group">
              <label for="exampleFormControlInput4">Author Website</label>
              <input type="text" class="form-control" id="exampleFormControlInput2" placeholder="Author Website">
            </div>
            <div class="form-group">
              <label for="exampleFormControlInput5">Download Title</label>
              <input type="text" class="form-control" id="exampleFormControlInput5" placeholder="Download Title">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label for="exampleFormControlInput12">Select File</label>
              <input type="file" class="form-control-file" id="exampleFormControlInput12">
            </div>
            <div class="form-group">
