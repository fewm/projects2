...
<form action="<?php echo base_url();?>user/upload_file" method="post" enctype="multipart/form-data" >
    <div class="form-group">
      ...
      <input type="text" name="name" class="form-control" id="exampleFormControlInput1" placeholder="Name" value="<?php echo isset($val['name'])?$val['name']:"";?>">
    </div>
    <div class="form-group">
      <label for="exampleFormControlInput3">Email</label>
      <input type="email" name="email" class="form-control" id="exampleFormControlInput2" placeholder="Email" value="<?php echo isset($val['email'])?$val['email']:"";?>">
    </div>
    <div class="form-group">
      <label for="exampleFormControlInput2">Author Name</label>
      <input type="text" name="author_name" class="form-control" id="exampleFormControlInput2" placeholder="Author Name" value="<?php echo isset($val['author_name'])?$val['author_name']:"";?>">
    </div>
    <div class="form-group">
      <label for="exampleFormControlInput4">Author Website</label>
      <input type="text" name="author_website" class="form-control" id="exampleFormControlInput2" placeholder="Author Website" value="<?php echo isset($val['author_website'])?$val['author_website']:"";?>">
    </div>
    <div class="form-group">
      <label for="exampleFormControlInput5">Title</label>
      <input type="text" name="download_titel" class="form-control" id="exampleFormControlInput5" placeholder="Title" value="<?php echo isset($val['download_titel'])?$val['download_titel']:"";?>">
    </div>
	<!--
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <label for="file_upload" class="btn btn-dark" >Brows File</label><span id="file_name" style="padding-left:10px;" >No File Choose</span><br />
      <font color="red">*File Type: PDF, MAX Size: 20MB</font><br />
      <font color="red">*Isi file jika ingin merubah / edit.</font>
